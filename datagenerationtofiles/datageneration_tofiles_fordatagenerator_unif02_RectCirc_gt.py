...
for epoch_i in range(num_train_instances):
    ...
    if testingdata:
       file_name = "datasynthetic/uniform02RectCircle-gt/testing/" + str(epoch_i) + "samples"
    else:
       file_name = "datasynthetic/uniform02RectCircle-gt/training/" + str(500+epoch_i) + "samples"
...
view_slices_3dNew(arr[ :, :, :], 50,
                50, 50, vmin=-0.4, vmax=0.4, title="gt")
