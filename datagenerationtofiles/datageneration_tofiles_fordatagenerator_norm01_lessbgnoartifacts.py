...
######################
 ...
 ######################
    ...
    if testingdata:
        file_name = "datasynthetic/normal01evenlessbglessartifacts/npz/testing/" + str(epoch_i) + "samples"
    else:
            file_name = "datasynthetic/normal01evenlessbglessartifacts/npz/" + str(epoch_i) + "samples"
    #     
