...
######################
 ...
 ######################
    ...
    if testingdata:
        file_name = "datasynthetic/gt1bg500_uni02evenlessbgnoartifacts/npz/testing/" + str(epoch_i) + "samples"
    else:
            file_name = "datasynthetic/gt1bg500_uni02evenlessbgnoartifacts/npz/" + str(epoch_i) + "samples"
    #     
