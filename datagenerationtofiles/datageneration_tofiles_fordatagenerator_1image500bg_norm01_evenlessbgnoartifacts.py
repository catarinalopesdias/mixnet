...
sim_gt[ :, :, :] = simulate_susceptibility_sources_norm( #simulate_susceptibility_sources_uni
...
######################
 ...
 ######################
    ...
    if testingdata:
        file_name = "datasynthetic/gt1bg500_normal01evenlessbgnoartifacts/npz/testing/" + str(epoch_i) + "samples"
    else:
            file_name = "datasynthetic/gt1bg500_normal01evenlessbgnoartifacts/npz/" + str(epoch_i) + "samples"
    #     
