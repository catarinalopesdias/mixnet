...
from  my_classes.DataGenerator_susc02_bgrem_evenlessbgnoartifacts import DataGeneratorUniformevenlessbgnoartifacts
...
#text regarding susc
text_susc="unif02"
training_generatorUnif   = DataGeneratorUniformevenlessbgnoartifacts(partition['train'])
validation_generatorUnif = DataGeneratorUniformevenlessbgnoartifacts(partition['validation'])
...
checkpoint_path = "checkpoints/bgremovalmodel/Bg_" +\
    ...
    "_loss_" + lossU + "_" + \
    text_lr +"_"+ lossmon+"_" + text_susc + "_datagen_evenlessbgnoartifacts.ckpt"
...
"_loss_" + lossU + \
"_" + text_lr + "_" + lossmon + "_" + text_susc + "_datagen_evenlessbgnoartifacts.keras"
...
"_gaaccum"+ str(gaaccumsteps) + \
"_loss_" + lossU + "_" + \
text_lr + "_" + "loss"+"_"+text_susc+"_datagen_evenlessbgnoartifacts"
...
"_gaaccum"+ str(gaaccumsteps) + \
"_loss_" + lossU + "_" + \
text_lr + "_" + lossmon+"_"+text_susc+"_datagen_evenlessbgnoartifacts"
