...
for epoch_i in range(num_train_instances):
    ...
    sim_gt[ :, :, :] = simulate_susceptibility_sources( #simulate_susceptibility_sources_uni
...
######################
 ...
 ######################
    ...
    if testingdata:
        file_name = "datasynthetic/normal01/npz/testing/" + str(epoch_i) + "samples"
    else:
            file_name = "datasynthetic/normal01/" + str(epoch_i) + "samples"
