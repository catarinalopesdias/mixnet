...
from  my_classes.dataGenerator.DataGenerator_norm01_bgrem_evenlessbgnoartifacts_onlyphaseExtraLayer import DataGeneratorNormalevenlessbgnoartifactsExtraLayer
...
#text regarding susc
text_susc="Normal01"
training_generatorNorm   = DataGeneratorNormalevenlessbgnoartifactsExtraLayer(partition['train'])
validation_generatorNorm = DataGeneratorNormalevenlessbgnoartifactsExtraLayer(partition['validation'])
...
history = model.fit( x=training_generatorNorm,
                    validation_data=training_generatorNorm,
