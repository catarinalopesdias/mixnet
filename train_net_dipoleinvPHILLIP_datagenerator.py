...
model_name1 = "models/dipoleinversion/model_DipInv_Phillip_newadam_" + str(num_filter)+"filters_trainsamples" + str(num_train_instances) + \
                "_datasetiter"+ str(dataset_iterations) + "_batchsize" + str(batch_size) + "_gaaccum" + str(gaaccumsteps) + \
                    "_loss_"+ lossU + text_lr +"_datagen.keras"
...
lossnamefile = "models/dipoleinversion/loss/model_DipInv_Phillip_newadam" + str(num_filter)+"trainsamples" \
    + str(num_train_instances) + "_datasetiter"+ str(dataset_iterations) + "_batchsize"+ str(batch_size)+ \
        "_gaaccum"+ str(gaaccumsteps) +"_loss_"+ lossU + text_lr +"_datagen"
