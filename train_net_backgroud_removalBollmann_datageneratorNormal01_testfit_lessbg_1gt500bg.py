...
from  my_classes.DataGenerator_norm01_bgrem_evenlessbg_1gt_500bg import DataGenerator_norm01_bgrem_evenlessbg_1gt_500bg
...
#text regarding susc
text_susc="norm01"
training_generatorNorm   = DataGenerator_norm01_bgrem_evenlessbg_1gt_500bg(partition['train'])
validation_generatorNorm = DataGenerator_norm01_bgrem_evenlessbg_1gt_500bg(partition['validation'])
