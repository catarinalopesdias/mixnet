...
class DataGenerator_unif02_bgrem_evenlessbg_1gt_500bg(keras.utils.Sequence):
    ...
    def __data_generation(self, list_IDs_temp):
      ...
      for i, ID in enumerate(list_IDs_temp):
          ...
          loaded = np.load('datasynthetic/gt1bg500_unif02evenlessbgnoartifacts/npz/' + ID + '.npz')
          #print(loaded )
          loaded =loaded['arr_0']
          #print(loaded )
