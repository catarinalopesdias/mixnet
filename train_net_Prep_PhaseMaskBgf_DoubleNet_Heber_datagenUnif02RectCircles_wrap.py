...
nettype = "4convs4levels_DoubleNet"
...
bgfremoval_phase= build_CNN_Heber_inputoutput(phasewithbackgroundfield)
dipinv_gt= build_CNN_Heber_inputoutput(bgfremoval_phase)

phaselevel = tf.keras.layers.Concatenate()([maskedPhase, build_CNN_Heber_inputoutput(phasewithbackgroundfield)])
##########################################
...
name = "PhaseMaskBgf_DoubleNet"+nettype
...
checkpoint_path = "checkpoints/preprocessing_doublenet/DN_" +\
    ...
    "_loss_" + lossU + "_" + \
    text_lr +"_"+ lossmon+"_" + text_susc + "_phasemaskbgf_doublenet_heber_datagenunif02rectcircles_wrap.ckpt"
...
model_name1 = "models/doublenet/model_Prep_doublenet_" + name + \
...
"_loss_" + lossU + \
"_" + text_lr + "_" + lossmon + "_" + text_susc + "_phasemaskbgf_doublenet_heber_datagenunif02rectcircles_wrap.keras"
...
lossnamefile = "models/doublenet/loss/model_Prep_doublenet_" + name + \
"_newadam" + str(num_filter)+"trainsamples" + str(num_train_instances) \
+ "_datasetiter"+ str(dataset_iterations) + "_batchsize"+ str(batch_size)+ \
"_gaaccum"+ str(gaaccumsteps) + \
"_loss_" + lossU + "_" + \
text_lr + "_" + "loss"+"_"+text_susc+"_phasemaskbgf_doublenet_heber_datagenunif02rectcircles_wrap"
...
plt.title(lossmon)
plt.xlabel("Dataset iterations")
vallossnamefile = "models/preprocessing_doublenet/loss/model_Prep_doublenet_" + name + \
"_newadam" + str(num_filter)+"trainsamples" + str(num_train_instances) \
+ "_datasetiter"+ str(dataset_iterations) + "_batchsize"+ str(batch_size)+ \
"_gaaccum"+ str(gaaccumsteps) + \
"_loss_" + lossU + "_" + \
text_lr + "_" + lossmon+"_"+text_susc+"_phasemaskbgf_doublenet_heber_datagenunif02rectcircles_wrap"
