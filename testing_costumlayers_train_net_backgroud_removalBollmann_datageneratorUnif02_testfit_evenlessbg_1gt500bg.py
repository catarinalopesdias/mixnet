...
from networks.network_adaptedfrom_BOLLMAN import extralayer_build_CNN_BOLLMAN
...
model = extralayer_build_CNN_BOLLMAN(input_tensor)
name = "Bollmann"
...
checkpoint_path = "checkpoints/bgremovalmodel/BR_extralayer" +\
...
model_name1 = "models/backgroundremovalBOLLMAN/model_BR_extralayer_" + name + \
...
lossnamefile = "models/backgroundremovalBOLLMAN/loss/model_BR_extralayer_" + name + \
...
plt.title(lossmon)
plt.xlabel("Dataset iterations")
vallossnamefile = "models/backgroundremovalBOLLMAN/loss/model_BR_extralayer_" + name + \
"_newadam" + str(num_filter)+"trainsamples" + str(num_train_instances) \
+ "_datasetiter"+ str(dataset_iterations) + "_batchsize"+ str(batch_size)+ \
"_gaaccum"+ str(gaaccumsteps) + \
"_loss_" + lossU + "_" + \
